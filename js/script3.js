...
class Memorama {
    ...
    constructor() {
        ...
        this.availableImages = ["borrego", "caballo", "gallina", "perro","guajolote", "uno", "dos", "tres", "cuatro", "cinco", "seis", "siete",
        "ocho", "nueve", "diez", "mama","papa", "hermanos", "abuela", "abuelo", "niña", "niño"];
    ...
    checkIfWon() {
        ...
        if (this.maxPairNumber == this.foundPairs) {
            ...
            alert("¡Ganaste el nivel Dificil!");
            this.setNewGame();
